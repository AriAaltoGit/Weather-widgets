export const FORECAST_KEY  = "36f9ee0e24551e594938b49dcf4ab7b9";
export const FORECAST_ROOT = "https://api.darksky.net/forecast/";
export const GOOGLE_KEY    = "AIzaSyDCAOzZNUybvO9b2zRZP1uWqVX6LyWjGIU";
export const GOOGLE_ROOT = "https://maps.googleapis.com/maps/api/geocode/json";
//const tokyo = {lat: 35.6584421, long: 139.7328635};
//export const LOCATIONS = [tokyo];
